...
import numpy as np
from snpe.converters.common.converter_ir.op_adapter import LstmOp, ReshapeOp
...
class LstmLayerBuilder(LayerBuilder):
    ...
    def build_layer(self, ir_graph, converter_context, descriptor, input_descriptors, output_descriptors):
        ...
        if not is_stacked_above_cell:
            ...
            input_layer_name = self._add_reshape_to_restore_time_dimension(
                ir_graph, converter_context, descriptor, cell_input_name, input_shape)
        else:
        ...
        return ir_graph.add(LstmOp(name=descriptor.output_names[0],
    ...
    @classmethod
    def _add_reshape_to_restore_time_dimension(cls, ir_graph, converter_context, descriptor, input_name, input_shape):
