...
from snpe.converters.common.converter_ir.op_adapter import SliceOp
...
class SliceLayerBuilder(LayerBuilder):
    def build_layer(self, ir_graph, converter_context, descriptor, input_descriptors, output_descriptors):
        ...
        output_shape = [input_shape[:]] * len(output_names)
        for i, shape in enumerate(output_shape):
            shape[descriptor.axis] = split_points_extended[i + 1] - split_points_extended[i]
