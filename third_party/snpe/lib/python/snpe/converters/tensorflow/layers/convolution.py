...
from snpe.converters.common.converter_ir.op_adapter import ConvolutionOp
...
class ConvolutionLayerBuilder(LayerBuilder):
    ...
    def calculate_padding_size(cls, input_size, output_size, strides, padding, filter_dims, dilation):
        pad_y, pad_x = 0, 0
        padding_size_strategy = "PADDING_SIZE_IMPLICIT_VALID"
        if padding.decode() == "SAME":
            ...
            pad_y //= 2
            pad_x //= 2
            padding_size_strategy = "PADDING_SIZE_IMPLICIT_SAME"
