...
from snpe.converters.common.converter_ir.op_adapter import PixelShuffleOp
...
class PixelShuffleLayerResolver(LayerResolver, object):
    ...
    def resolve_layer(self, graph_matcher, graph_helper):
        ...
        for match in matches:
            ...
            data_format = depth_to_space_op.get_attr(self.TF_ATTRIBUTE_DATA_FORMAT)
            snpe_converter_utils.log_assert(data_format in self.TF_ATTRIBUTE_SUPPORTED_DATA_FORMAT,
