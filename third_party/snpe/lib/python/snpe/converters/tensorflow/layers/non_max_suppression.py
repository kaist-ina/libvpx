...
from snpe.converters.common.converter_ir.op_adapter import NonMaxSuppresionOp, ReshapeOp
...
class NonMaxSuppressionLayerBuilder(LayerBuilder):
    ...
    def _build_input_layers(self, ir_graph, converter_context, descriptor, names):
        """
