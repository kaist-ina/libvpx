...
import numpy as np
from snpe.converters.common.converter_ir.op_adapter import MomentOp
...
class MomentsLayerBuilder(LayerBuilder):
    def build_layer(self, ir_graph, converter_context, descriptor, input_descriptors, output_descriptors):
        ...
        :type converter_context: snpe.converters.tensorflow.tf_to_ir.ConverterContext
        :type descriptor: ReductionLayerResolver.Descriptor
        :rtype: int
        """
        input_name = self.get_input_name(converter_context, descriptor, input_descriptors)

        return ir_graph.add(MomentOp(name=descriptor.layer_name,
