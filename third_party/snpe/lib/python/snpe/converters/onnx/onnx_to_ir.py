...
try:
    ...
    raise Exception(code_to_message.get_error_message("ERROR_ONNX_NOT_FOUND")(e.message, str(sys.path)))

from snpe.converters.common.converter_ir import op_graph_optimizations, op_policies
