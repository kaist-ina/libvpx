...
from snpe.converters.common.converter_ir import op_graph_optimizations, op_adapter, translation
...
class CaffeConverter(ConverterBase):
    ...
    def convert(self):
        ...
        try:
            ...
            raise Exception(code_to_message.get_error_message("ERROR_CAFFE_NOT_FOUND")(e.message, str(sys.path)))
